        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="role-card editor">
                    ...
                    <ul class="role-features">
                        <li><i class="bi bi-check2"></i> Skapa kurser (manuellt, AI, PowerPoint eller SCORM)</li>
            ...
            <div class="table-responsive">
                <table class="table table-sm align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr><td>Skapa kurser (manuellt / AI / PPTX / SCORM)</td><td class="text-center text-muted">–</td><td class="text-center text-success">✓</td><td class="text-center text-success">✓</td><td class="text-center text-success">✓</td></tr>
                        ...
                        <tr><td>Importera kurs (ZIP / PPTX / SCORM)</td><td class="text-center text-muted">–</td><td class="text-center text-success">✓</td><td class="text-center text-success">✓</td><td class="text-center text-success">✓</td></tr>
...
<div class="row mb-5" id="redaktorer">
    <div class="col-12">
        ...
        <div class="accordion custom-accordion" id="editorAccordion">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#scormImport">
                        <i class="bi bi-box-seam me-2"></i>Importera SCORM-paket
                    </button>
                </h2>
                <div id="scormImport" class="accordion-collapse collapse" data-bs-parent="#editorAccordion">
                    <div class="accordion-body">
                        <p>Ett SCORM-paket (<code>.zip</code>) från Rise 360, Storyline, iSpring, Captivate eller en LMS-export kan göras om till en vanlig Stimma-kurs.</p>

                        <div class="tip-box info">
                            <div class="tip-icon"><i class="bi bi-shield-lock"></i></div>
                            <div class="tip-content">
                                <strong>Paketet spelas inte upp i Stimma</strong>
                                <p class="mb-0 mt-2">Stimma är ingen SCORM-spelare. Importen läser paketets innehållsförteckning (<code>imsmanifest.xml</code>), plockar ut text och bilder och låter AI skriva om innehållet till vanliga lektioner. Paketets egen HTML och JavaScript körs aldrig — främmande JavaScript på Stimmas domän skulle kunna komma åt inloggade användares sessioner.</p>
                            </div>
                        </div>

                        <h6 class="mt-4 mb-2"><i class="bi bi-1-circle me-2 text-primary"></i>Så gör du</h6>
                        <ol class="styled-list">
                            <li>Gå till <strong>Kurser</strong> och klicka <strong>"Importera SCORM"</strong></li>
                            <li>Välj paketets <code>.zip</code>-fil (max 100 MB)</li>
                            <li>Välj ton, textlängd, svårighetsgrad, språkstil, quiz och AI-tutor — samma inställningar som AI-kursgenereringen</li>
                            <li>Klicka <strong>"Ladda upp och bearbeta"</strong> — kursen genereras i bakgrunden (typiskt 1-3 minuter)</li>
                        </ol>

                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <div class="mini-card">
                                    <h6><i class="bi bi-check-circle me-2 text-success"></i>Följer med</h6>
                                    <ul class="small text-muted mb-0 ps-3">
                                        <li>Kurstitel och avsnittsstruktur</li>
                                        <li><strong>Originaltexten</strong> — ordagrant i kopieringsläget</li>
                                        <li><strong>Alla bilder</strong> i den lektion de hörde till</li>
                                        <li><strong>Alla filmer</strong> kopieras in och spelas i lektionen</li>
                                        <li>Frågor och svarsalternativ som text</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mini-card">
                                    <h6><i class="bi bi-x-circle me-2 text-danger"></i>Följer inte med</h6>
                                    <ul class="small text-muted mb-0 ps-3">
                                        <li><strong>Paketets provlogik och poängsättning</strong> — frågorna följer med som text men rättas inte</li>
                                        <li>Interaktioner, animationer, förgreningar och grafisk design</li>
                                        <li>Text som ligger som bild (vanligt i iSpring/Captivate)</li>
                                        <li>Max 25 avsnitt och 100 MB per import</li>
                                    </ul>
                                </div>
                            </div>
                        </div>

                        <h6 class="mt-4 mb-2"><i class="bi bi-2-circle me-2 text-primary"></i>Kopiera eller låta AI skriva om?</h6>
                        <p class="text-muted small mb-1"><strong>Kopiera innehållet</strong> (standard) behåller originalets text ordagrant, lägger alla bilder i rätt lektion och kopierar in alla filmer som spelas direkt i lektionen. Ingen AI, inga tokens, klart på några sekunder. <strong>Låt AI skriva om</strong> återförfattar texten till Stimmas lektionsformat med nya quizfrågor — välj det när du vill ha nytt material snarare än en kopia.</p>
                        <p class="text-muted small mb-1">Avsnittsindelningen i paketet blir kursens lektioner. För Storyline-paket läses innehållet ur paketets egen datamodell: varje scen blir en lektion och scenens film blir lektionens video.</p>

                        <div class="tip-box warning mt-3">
                            <div class="tip-icon"><i class="bi bi-exclamation-triangle-fill"></i></div>
                            <div class="tip-content">
                                <strong>Två saker att kontrollera innan du importerar</strong>
                                <ul class="mb-0 mt-2">
                                    <li><strong>Compliance:</strong> ska någon kunna visa godkänt på <em>just paketets prov</em> fungerar inte importen — provlogiken följer inte med.</li>
                                    <li><strong>Licens:</strong> köpta paket är normalt licensierade för uppspelning, inte för omarbetning till eget redigerbart material.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="tip-box success mt-3">
                            <div class="tip-icon"><i class="bi bi-lightbulb-fill"></i></div>
                            <div class="tip-content">
                                <strong>Kvaliteten beror på källverktyget</strong>
                                <p class="mb-0 mt-2">SCORM standardiserar bara förpackningen, inte innehållet. <strong>Storyline</strong> läses direkt ur paketets datamodell och ger bäst resultat. <strong>Vanliga HTML-paket</strong> städas och sparas med bilderna kvar. <strong>Rise 360, iSpring och Captivate</strong> lagrar innehållet i JavaScript-data — det skördas därifrån, men strukturen blir enklare. Får du felmeddelandet att inget innehåll hittades ligger texten troligen som bilder; exportera då kursen som PowerPoint eller Word istället. Kursen skapas alltid <strong>inaktiv</strong> så att du kan granska den först.</p>
                            </div>
                        </div>
                    </div>
                </div>
