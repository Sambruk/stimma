...
function initStimmaEditor(selector, fullToolbar) {
    ...
    tinymce.init({
        selector: selector,
        // TinyMCE 7 kräver att GPL-bygget deklarerar sin licens, annars visas
        // en licensvarning i editorn. Stimma är GPL v2 och TinyMCE 7 är
        // GPLv2-or-later — kompatibelt.
        license_key: 'gpl',
        language: 'sv_SE',
        height: editorHeight,
        menubar: false,
        ...
        // Säkerhet: båda är default i TinyMCE 7 men sätts explicit så att
        // beteendet inte tyst ändras om en framtida version byter default.
        // Under v6 var de nödvändiga — se CVE-klasserna för iframe/embed.
        ...
        // Inklistra-hantering. Obs: paste_word_valid_elements var en v5-option
        // och togs bort när paste blev en kärnfunktion i v6 — den har alltså
        // varit verkningslös här hela tiden och är borttagen. Det som faktiskt
        // filtrerar inklistrat innehåll är valid_elements ovan.
        paste_as_text: false,
