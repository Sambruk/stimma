...
<head>
    ...
    <!-- TinyMCE Editor -->
    <!-- TinyMCE 7.9.3 (2026-08-13). Version 6.8.5 ligger kvar i include/js/tinymce/
         tills 7.x är verifierad i skarp redigering — rollback = byt sökvägen här. -->
    <script src="include/js/tinymce7/tinymce.min.js"></script>
